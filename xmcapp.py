...
if 'df' in st.session_state:
    ...
    fig = go.Figure()
    fig.add_trace(go.Scattergl(x=np.arange(len(saldos_cumulativos_com_inicio)), y=saldos_cumulativos_com_inicio, mode='lines', name='Saldo Cumulativo', line=dict(color='AA0000', width=3, dash='solid')))
